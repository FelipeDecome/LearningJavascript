...
System.register(["./controllers/NegociacaoController.js"], function (_export, _context) {
  ...
  return {
    setters: [function (_controllersNegociacaoControllerJs) {
      currentInstance = _controllersNegociacaoControllerJs.default;
    }],
    execute: function () {
      ...
      document.querySelector("#apagar").onsubmit = negociacaoController.esvazia.bind(negociacaoController);
    }
  };
});
