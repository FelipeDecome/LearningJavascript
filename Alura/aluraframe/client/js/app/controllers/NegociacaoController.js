...
System.register(["./../models/ListaNegociacoes.js", "./../views/NegociacoesView.js", "./../models/Negociacao.js", "./../models/Mensagem.js", "./../Views/MensagemView.js", "./../helpers/Bind.js", "./../helpers/DateHelper.js", "./../services/NegociacoesService.js"], function (_export, _context) {
  "use strict";

  var ListaNegociacoes, NegociacoesView, Negociacao, Mensagem, MensagemView, Bind, DateHelper, NegociacoesService, _createClass, NegociacaoController, negociacaoController;
  ...
  _export("default", currentInstance);
  ...
  return {
    setters: [function (_modelsListaNegociacoesJs) {
      ...
      NegociacoesService = _servicesNegociacoesServiceJs.default;
    }],
    execute: function () {
